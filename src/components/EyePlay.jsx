...
export default function EyePlay() {
  ...
  return (
    <div className="eyes w-full h-screen bg-red-500 overflow-hidden">
      <div data-scroll data-scroll-speed="-0.6" className="relative w-full h-full bg-cover bg-center bg-[url('https://ochi.design/wp-content/uploads/2022/05/Top-Viewbbcbv-1-1440x921.jpg')]">
